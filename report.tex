...
In the provided code, the two different algorithms were applied to an e-commerce dataset \cite{millat2024ecommerce} to segment customers based on various features such as number of orders, total spending, average order value, and product category preferences.
